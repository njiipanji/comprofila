<div class="row marketing" style="padding: 0px 15px">
	<ul class="nav nav-pills nav-justified" id="bigmenu">
		...
		<li role="presentation" class="dropdown">
			<a href="#" data-toggle="dropdown" class="dropdown-toggle menu-nav"><i class="fa fa-building" aria-hidden="true"></i> Bussiness Unit <b class="caret"></b></a>
		...
		<li role="presentation"><a href="contact.php" class="menu-nav"><i class="fa fa-envelope" aria-hidden="true"></i> Contact Us</a></li>
	</ul>
</div>